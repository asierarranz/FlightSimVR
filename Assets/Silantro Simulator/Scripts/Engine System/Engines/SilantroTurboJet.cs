...
public class SilantroTurboJet : MonoBehaviour {
	...
	public float OverallPressureRatio = 1f;
	//
	...
	public Transform intakeFanPoint;
	...
	[HideInInspector]
	public float intakeArea;
	[HideInInspector]
	public float exhaustArea ;
	float fanThrust;
	float fanAirMassFlow;public bool captured;
	//
	//
